...
const programs = [
  {
    ...
    body: "Veterans of different eras and branches gather with family members, friends, and civilians for informal breakfasts and other events built around conversation rather than speeches.",
  },
  {
    number: "02",
    icon: Radio,
    title: "Weekly live conversations",
    body: "Online programs give veterans across the country room to talk about service, military history, difficult experiences, funny memories, and the details civilians rarely hear.",
  },
  {
    number: "03",
    icon: BookOpen,
    title: "Stories that stay accessible",
    body: "The Veterans History Project, VBC Magazine, VBC Bulletin, The Scuttlebutt, and special projects preserve first-person stories so they can keep educating families and the public long after the conversation ends.",
  },
  {
    number: "04",
    icon: Home,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Beyond The Yellow features Veterans Breakfast Club and Director of Programming Shaun Hall: how listening, storytelling, and informal community create space for veterans to share stories they may have carried for decades."
        />
        <meta
          property="og:title"
          content="Sometimes the story comes out only when the right room exists. | Veterans Breakfast Club"
        />
        <meta
          property="og:description"
          content="Veterans Breakfast Club creates communities of listening where veterans can be heard, families can learn stories they have never heard, and military history stays alive through the people who lived it."
        />
        <meta property="og:image" content={welcomeCenterImage} />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <link
          rel="canonical"
          href="https://www.valorwell.org/veteransbreakfastclub"
        />
      </Helmet>
      ...
      <main id="main" className="overflow-hidden bg-background">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-14 md:py-20 lg:grid-cols-12 lg:items-center lg:gap-14 lg:py-24">
            <div className="lg:col-span-6">
              ...
              <p className="mt-7 max-w-2xl text-base leading-7 text-white/75 sm:text-lg sm:leading-8">
                Veterans Breakfast Club builds communities around one deceptively simple act: listening. In the Beyond The Yellow conversation, Shaun Hall explains why veterans will sometimes share memories with a room of strangers that they have never told their own families—and what can happen when they finally feel safe enough to talk.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-md bg-[hsl(var(--gold-accent))] px-5 py-3 text-sm font-black text-[hsl(var(--navy))] transition hover:brightness-95"
                >
              ...
              <figure className="relative">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/15 bg-black shadow-2xl shadow-black/40">
                  <img
                    ...
                    alt="Veterans, supporters, and community members gathered at the Veterans Breakfast Club Welcome Center in Pittsburgh"
                    className="aspect-[4/3] h-full w-full object-cover opacity-90"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-transparent to-transparent" />
                  <figcaption className="absolute inset-x-0 bottom-0 p-6 text-sm leading-6 text-white/75 md:p-8">
                    In 2026, Veterans Breakfast Club opened its first permanent Welcome Center after nearly two decades of gathering veterans and civilians around stories.
                  </figcaption>
                </div>
              </figure>
            </div>
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-9">
              <p className="max-w-4xl text-2xl font-bold leading-tight tracking-tight text-foreground sm:text-3xl md:text-4xl">
                Beyond The Yellow is about action people can feel. Sometimes that action is not building a house or driving someone to an appointment. Sometimes it is creating the conditions for a person to finally be heard.
              </p>
              <p className="mt-7 max-w-3xl text-base leading-8 text-muted-foreground md:text-lg">
                VBC treats listening as something active. Their programs make room for the ordinary, funny, painful, complicated, and historically important parts of military service—without requiring a veteran to turn the experience into a speech, a heroic story, or a polished lesson for civilians.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border-y border-border bg-[hsl(var(--section-alt))] py-16 md:py-24">
          <div className="mx-auto max-w-5xl px-4">
            ...
            <h2 className="mt-4 max-w-4xl text-3xl font-black leading-tight tracking-tight text-foreground md:text-5xl">
              No podium. No pressure. Just a microphone moving around the room.
            </h2>
            <div className="mt-7 grid gap-6 text-base leading-8 text-muted-foreground md:grid-cols-2 md:text-lg">
              <p>
              ...
              <p>
                Shaun describes a format designed to lower the stakes. Veterans are not asked to walk to a podium and perform. The microphone moves through the room. One memory triggers another. Someone hears a familiar phrase, raises a hand, and suddenly the room is full of people who understand the language without needing every detail translated.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative bg-[hsl(var(--navy))] py-16 text-white md:py-20">
          <div className="relative mx-auto max-w-6xl px-4">
            ...
            <p className="mt-10 text-xs text-white/45">
              Current program and reach figures are reported by Veterans Breakfast Club in its public materials. Magazine reach combines more than 8,000 mailed copies with another 7,500 distributed by hand per quarterly issue.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-muted-foreground md:text-lg">
                The line gets to the heart of VBC. Supporting veterans does not always begin with having the answer. Sometimes it begins with staying in the conversation long enough to hear what the person actually wants to say.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-10 lg:grid-cols-12 lg:items-end">
              ...
              <div className="lg:col-span-5">
                <p className="text-base leading-8 text-muted-foreground">
                  VBC has expanded the original breakfast-table idea into a network of in-person, online, print, audio, archival, and community programs without losing the informal conversation at the center.
                </p>
              </div>
            </div>
                ...
                return (
                  <article key={item.title} className="rounded-2xl border border-border bg-card p-7 shadow-sm">
                    <div className="flex items-center justify-between gap-4">
                      <span className="text-xs font-black tracking-[0.18em] text-[hsl(var(--gold-accent))]">
                        {item.number}
                      </span>
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 lg:grid-cols-12 lg:items-center lg:gap-16">
            <div className="lg:col-span-7">
              ...
              <p className="mt-6 max-w-3xl text-base leading-8 text-muted-foreground md:text-lg">
                In the interview, Shaun describes veterans saying they had never talked about certain experiences before—even with family. A VBC conversation can become the first opening: a chance to get something off their chest, reconnect with someone from the past, or go home ready to continue a conversation that had been avoided for years.
              </p>
            </div>
            <div className="lg:col-span-5">
            ...
            <div className="grid gap-10 rounded-[2rem] border border-border bg-card p-7 shadow-sm md:p-10 lg:grid-cols-12 lg:items-center lg:p-12">
              ...
              <div className="space-y-3 lg:col-span-5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-between gap-4 rounded-xl border border-border px-5 py-4 text-sm font-bold text-foreground transition hover:border-[hsl(var(--navy))]/35"
                >
