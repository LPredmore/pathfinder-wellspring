...
const differentiators = [
  {
    ...
    description:
      "We accept CHAMPVA and aim to make the process as straightforward as possible—so you can focus on care, not paperwork.",
    icon: CreditCard,
  },
  {
    title: "Military-Centered Care",
    description:
      "Our clinicians understand military culture and the realities veterans and families face—because context matters in care.",
    icon: Shield,
  },
  {
...
const values = [
  {
    title: "Access-First",
    description:
      "We design for real-world barriers—availability, logistics, and complexity—so more people can start sooner.",
    icon: ClipboardList,
  },
  {
    title: "Respect + Compassion",
    description:
      "We meet people where they are with dignity and empathy. No judgment—only practical support and clarity.",
    icon: Heart,
  },
  {
    title: "Community Matters",
    description:
      "Healing is not only individual. We create structured spaces for connection, shared learning, and mutual support.",
    icon: Users,
  },
  {
    title: "Integrity + Evidence-Informed",
    description:
      "We prioritize approaches grounded in proven methods—and we communicate clearly about what each service is and isn’t.",
    icon: Target,
  },
];
  ...
  return (
    <Layout>
      <Hero
        ...
        subtitle="We’re building clearer, more accessible mental health support for veterans and families—through therapy when available, and practical support options that help people keep moving forward."
        ctaText="Get Started"
        ctaLink="/get-started"
      />
      ...
      <section className="section-padding">
        <div className="container-narrow">
          ...
          <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
            <p>
              ValorWell was born from a personal experience navigating the gaps in access that many veteran families
              face—finding providers who understand military culture, understanding benefits, and dealing with
              administrative friction that delays care.
            </p>
            <p>
      ...
      <section className="section-padding section-alt">
        <div className="container-narrow">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ValorWell exists to improve access to high-quality, military-centered mental health support. We believe
            veterans, service members, and their families deserve care that respects their experience, reduces friction,
            and focuses on practical progress.
          </p>
